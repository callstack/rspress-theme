...
The command is started through the React Native Community CLI's `start` command, which is overridden [inside `react-native.config.js`](/rspress-theme/pr-preview/pr-122/index.md) to spawn Re.Pack's dev server.
...
1. [Inlining assets as base64 strings](/rspress-theme/pr-preview/pr-122/test/guide.md)
2. [Converting to remote assets](/rspress-theme/pr-preview/pr-122/test/guide.md)
3. [Adding SVG support](/rspress-theme/pr-preview/pr-122/test/guide.md)
...
- [Inlining assets as base64 strings](/rspress-theme/pr-preview/pr-122/test/guide.md)
- [Converting to remote assets](/rspress-theme/pr-preview/pr-122/test/guide.md)
- [Adding SVG support](/rspress-theme/pr-preview/pr-122/test/guide.md)
